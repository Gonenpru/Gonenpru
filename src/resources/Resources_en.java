...
public class Resources_en extends ListResourceBundle {
	...
	static final Object[][] contents = {
			...
			{"home.aboutus.title", "About Gonenpru Airport"},
			{"home.aboutus.sub", "Best International Airport in the World"},
			{"home.aboutus.desc", "Passengers of all the world trust us for bussines, vacations and much more due to our service."},
			{"home.aboutus.travelers", "Travelers"},
			{"home.aboutus.flights", "Flights"},
			{"home.blogs", "Blogs"},
			...
			{"home.blogs.takealook", "Take a Look"},
			...
			{"home.contactus.subscribe", "Subscribe To Our Newsletter"},
			{"home.contactus.email", "Your E-Mail Here..."},
			{"home.contactus.submit", "Submit"},
			{"timetable.time", "Time"},
			{"timetable.flight", "Flight"},
			{"timetable.origin", "Origin"},
			{"timetable.status", "Status"},
			{"timetable.track", "Track"},
			{"timetable.moreinfo", "More Info"},
			{"language.en", "English"},
			{"language.es", "Spanish"},
			{"language.eu", "Basque"},
	};
