...
public class Resources_eu extends ListResourceBundle {
	...
	static final Object[][] contents = {
			{"home.welcometo", "Ongi Etorri"},
			{"home.flightinfo", "Hegaldien Informazioa"},
			{"home.timetable", "Ordutegi Taula"},
			...
			{"home.photos", "Argazkiak"},
			{"home.contactus", "Harremanetan Jarri"},
			{"home.contactus.subscribe", "Suscribete a Nuestra Newsletter"},
			{"home.contactus.email", "Zure E-Maila Hemen..."},
			{"home.contactus.submit", "Bidali"},
			{"timetable.time", "Ordua"},
			{"timetable.flight", "Vuelo"},
			{"timetable.origin", "Origen"},
			{"timetable.status", "Estado"},
			{"timetable.track", "Seguimiento"},
			{"timetable.moreinfo", "Info Gehiago"},
			{"language.en", "Ingelesa"},
			{"language.es", "Gaztelaniera"},
			{"language.eu", "Euskera"},
	};
